"""Tests for deterministic token generation, fuzzy resolution, and pool validation."""
...
class TestDeterministicGeneration:
    ...
    def test_random_generate_token_also_sorted(self) -> None:
        for _ in range(20):
...
class TestFuzzyResolve:
    ...
    def test_exact_match_returns_no_suggestion(self) -> None:
        ...
        parts = token.split("-")
        # All three words are valid pool words
        all_words = set(POOL_PLACES) | set(POOL_MUSIC) | set(POOL_NOLA)
